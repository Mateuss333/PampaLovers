...
import { Plus, Minus, Satellite, Map as MapIcon, Calendar, Crosshair } from "lucide-react"
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Mapa base con tus lotes dibujados cuando tengan polígono guardado.
          </p>
        </div>
            ...
            <Card className="border-border/60">
              ...
              <CardContent>
                {loading || !lots ? (
                  ...
                  <div className="max-h-[min(480px,70vh)] space-y-1 overflow-y-auto pr-1">
                    {lots.map((lot) => (
                      <button
                        key={lot.id}
                        type="button"
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <div
                            className={`h-3 w-3 shrink-0 rounded ${cropColors[lot.crop] || "bg-muted"}`}
                          />
