...
if (import.meta.main) {
  Deno.serve(async (request) => {
    ...
    try {
      ...
      console.log("[fetch-plot-weather] Incoming request", {
      ...
      console.log("[fetch-plot-weather] Resolved date range", {
        plotId: payload.plotId,
        dateFrom,
        dateTo,
        dateSource,
      ...
      const weather = await fetchWeatherFromEos(location, dateFrom, dateTo);
